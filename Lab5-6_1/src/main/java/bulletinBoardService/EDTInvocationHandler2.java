...
public class EDTInvocationHandler2 extends JFrame implements InvocationHandler{
    ...
    public EDTInvocationHandler2(UITasks ui) {
        this.ui = ui;
    }
    public EDTInvocationHandler2() {
    ...
    public void InitFrame() {
            ...
            connectButton.addActionListener(arg0->{
                UITasks ui = (UITasks) Proxy.newProxyInstance(getClass().getClassLoader(),
                        ...
                        new EDTInvocationHandler2(new UITasksImpl()));
    ...
    public static void main(String[] args) {
        EDTInvocationHandler2 edtInvocationHandler = new EDTInvocationHandler2();
